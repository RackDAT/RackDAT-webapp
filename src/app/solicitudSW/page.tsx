...
const solicitud_software = () => {
  return (
    ...
    <div className='h-full  bg-[#EDEDED] flex items-center justify-center m-10 w-1/2 rounded-md'>
      <Image src='/assets/img/software.png' alt='software' width={50} height={50} />
      <Form className='w-1/2 h-full m-5 flex flex-col gap-5 p-5 justify-items-center flex-wrap'>
        ...
        <div className='flex flex-col gap-5'  >
          ...
          <Field as='textarea' name='justnotes' type='text' rows={4} className='w-full h-20 p-2 border-2 border-gray-300 rounded-md resize-none' placeholder='Insertar notas u observaciones' />
        </div>
        <Btn> Solicitar </Btn>
